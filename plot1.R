...
?write.table
getwd()
##1. Draw un histogramme
library(datasets)
par(mar=c(5.1,4.1,4.1,2.1))

png(filename="./plot1.png",width=480,height=480,units="px")
hist(ndatabase$Global_active_power,col="red",main="Global Active Power",xlab="Global Active Power (kilowatts)")
par(oma=c(1,1,4,4))
mtext("Plot 1", side=3,outer=TRUE,line=3,adj=0,padj=0)
dev.off()